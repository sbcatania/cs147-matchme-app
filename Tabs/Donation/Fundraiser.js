...
export default function Fundraiser() {
    ...
    const donate = () => {
      navigation.navigate("DonationEntry", {fundraisername: fundraisername});
    };
    return(
